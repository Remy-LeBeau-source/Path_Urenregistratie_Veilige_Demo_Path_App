...
De native Playwright specs zijn de uitvoerbare waarheid. Deze Living Documentation maakt dezelfde 521 Playwright-cases leesbaar en voegt 1 directe DB/SQL-case(s) toe zonder een tweede testrunner te introduceren.

## Actuele regressiestatus

- Playwright executable cases: 521 unieke case-ID's
- SQL/DB executable cases: 1 unieke case-ID('s)
- Totaal executable cases: 522 unieke case-ID's
...
De 41 Mobile-cases worden op twee devices uitgevoerd. Daarom leveren 521 Playwright-functionele cases in totaal 562 resultaten op: 480 + (41 x 2) = 562.

...
De native Playwright specs zijn de uitvoerbare waarheid. Deze Living Documentation maakt dezelfde 517 Playwright-cases leesbaar en voegt 1 directe DB/SQL-case(s) toe zonder een tweede testrunner te introduceren.

## Actuele regressiestatus

- Playwright executable cases: 517 unieke case-ID's
- SQL/DB executable cases: 1 unieke case-ID('s)
- Totaal executable cases: 518 unieke case-ID's
- Playwright features: 30
- Database features: 1
- Playwright steps mappings: 30
- Database steps mappings: 1
- Uitvoeringen: 558
- Niet-mobile projectuitvoeringen: 476
- Mobile functionele cases: 41
- Pixel 7 / Chromium-uitvoeringen: 41
- iPhone 13 / WebKit-uitvoeringen: 41

De 41 Mobile-cases worden op twee devices uitgevoerd. Daarom leveren 517 Playwright-functionele cases in totaal 558 resultaten op: 476 + (41 x 2) = 558.
...
- [DASH-H-029] na het opnieuw indienen van een correctie komt de medewerker op Mijn maanden uit — Techniek: Beslissingstabel rollen en autorisatie · Assertions: 4

...
| 41 | Bij indienen komt de mail nu bij iedereen binnen (bevestigd door gebruiker), maar nergens in onderwerp of body staat dat het een TEST-mail is. `server/mail/dispatch.php` en `server/mail/queue.php` bevatten geen TEST-marker op dit moment. Mailteksten zijn main-terrein. | gebruiker | open, main |

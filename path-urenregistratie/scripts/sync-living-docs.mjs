...
const definitions = [
  ...
  { kind: 'playwright', spec: 'admin-writes.spec.ts', feature: 'admin-writes.feature', steps: 'admin-writes.steps.ts', name: 'Beheer- en instellingenwijzigingen via API', tags: ['regressie', 'api', 'fase:2'], parentSuite: 'API', suite: 'Admin Writes', allureFeature: 'Beheer & Instellingen', phase: 2 },
  ...
  { kind: 'playwright', spec: 'email-queue.spec.ts', feature: 'email-queue.feature', steps: 'email-queue.steps.ts', name: 'E-mailqueue, ontvangers en afleverbeleid', tags: ['regressie', 'api', 'fase:12'], parentSuite: 'API', suite: 'Email Queue', allureFeature: 'E-mailverwerking', phase: 12 },
  ...
  { kind: 'playwright', spec: 'invoices.spec.ts', feature: 'invoices-ui.feature', steps: 'invoices-ui.steps.ts', name: 'Facturen in de desktop-UI', tags: ['regressie', 'ui', 'desktop', 'fase:11'], parentSuite: 'UI Desktop', suite: 'Facturen', allureFeature: 'Facturatie', phase: 11 },
  ...
  { kind: 'playwright', spec: 'notifications.spec.ts', feature: 'notifications.feature', steps: 'notifications.steps.ts', name: 'Meldingen en notificaties', tags: ['regressie', 'api', 'fase:15'], parentSuite: 'API', suite: 'Notifications', allureFeature: 'Notificaties', phase: 15 },
  ...
  { kind: 'playwright', spec: 'period-management.spec.ts', feature: 'period-management.feature', steps: 'period-management.steps.ts', name: 'Maanden openen en sluiten', tags: ['regressie', 'api', 'fase:15'], parentSuite: 'API', suite: 'Period Management', allureFeature: 'Periodebeheer', phase: 15 },
  ...
  { kind: 'playwright', spec: 'roles-api.spec.ts', feature: 'roles-api.feature', steps: 'roles-api.steps.ts', name: 'Rollen, rechten en gegevensafscherming', tags: ['regressie', 'security', 'fase:4'], parentSuite: 'Security', suite: 'Role Scope', allureFeature: 'Audit & Security', phase: 4 },
  ...
  { kind: 'playwright', spec: 'timesheet-review-flow.spec.ts', feature: 'timesheets-review-integration.feature', steps: 'timesheets-review-integration.steps.ts', name: 'Correcties en goedkeuringen via API', tags: ['regressie', 'integration', 'fase:9'], parentSuite: 'DB / Integratie', suite: 'Optimistic Locking', allureFeature: 'Correctie & Goedkeuring', phase: 9 },
  { kind: 'playwright', spec: 'timesheet-review-ui.spec.ts', feature: 'timesheets-review-ui.feature', steps: 'timesheets-review-ui.steps.ts', name: 'Correcties en goedkeuringen in de desktop-UI', tags: ['regressie', 'ui', 'desktop', 'fase:9'], parentSuite: 'UI Desktop', suite: 'Correcties', allureFeature: 'Correctie & Goedkeuring', phase: 9 },
  ...
  { kind: 'playwright', spec: 'user-management.spec.ts', feature: 'user-management.feature', steps: 'user-management.steps.ts', name: 'Gebruikers en medewerkers beheren', tags: ['regressie', 'api', 'fase:13'], parentSuite: 'API', suite: 'User Management', allureFeature: 'Gebruikersbeheer', phase: 13 },
...
if (playwrightCount !== 171 || dbCount !== 1 || inventory.length !== 172 || uniqueIds.size !== 172) {
  throw new Error(`Verwacht 171 Playwright-cases + 1 DB-case = 172 unieke cases, gevonden ${playwrightCount}/${dbCount}/${inventory.length}/${uniqueIds.size}.`);
}

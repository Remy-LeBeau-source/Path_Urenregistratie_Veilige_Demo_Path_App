...
if (playwrightCount !== 166 || dbCount !== 1 || inventory.length !== 167 || uniqueIds.size !== 167) {
  throw new Error(`Verwacht 166 Playwright-cases + 1 DB-case = 167 unieke cases, gevonden ${playwrightCount}/${dbCount}/${inventory.length}/${uniqueIds.size}.`);
}

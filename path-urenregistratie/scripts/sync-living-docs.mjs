...
if (playwrightCount !== 223 || dbCount !== 1 || inventory.length !== 224 || uniqueIds.size !== 224) {
  throw new Error(`Verwacht 223 Playwright-cases + 1 DB-case = 224 unieke cases, gevonden ${playwrightCount}/${dbCount}/${inventory.length}/${uniqueIds.size}.`);
}

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.105"), "Het zichtbare versienummer moet 2.0.105 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.105) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.105 volledige smoke test: geslaagd");

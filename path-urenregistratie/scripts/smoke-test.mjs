...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.169"), "Het zichtbare versienummer moet 2.0.169 zijn");
...
dom.window.close();
console.log("Path v2.0.169 volledige smoke test: geslaagd");

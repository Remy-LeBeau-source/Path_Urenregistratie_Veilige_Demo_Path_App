...
assert(styles.includes("v0.9.37 · mobiele bediening") && styles.includes("@media (max-width: 720px)"), "Versie 0.9.37 moet een expliciete mobiele touch-layout hebben");
...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.37"), "Het zichtbare versienummer moet 0.9.37 zijn");
...
assert(demoScenarioState.schemaVersion === 23, "Versie 0.9.37 moet wijzigingen onder de juiste gegevensversie bewaren");
...
assert(migratedState.schemaVersion === 23, "Bestaande browsergegevens moeten ook in v0.9.37 veilig behouden blijven");
...
console.log("Path v0.9.37 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.204"), "Het zichtbare versienummer moet 2.0.204 zijn");
...
console.log("Path v2.0.204 volledige smoke test: geslaagd");

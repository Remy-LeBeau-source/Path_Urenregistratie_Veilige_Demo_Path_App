...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.123"), "Het zichtbare versienummer moet 2.0.123 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.123) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.123 volledige smoke test: geslaagd");

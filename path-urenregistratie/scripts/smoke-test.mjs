...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.184"), "Het zichtbare versienummer moet 2.0.184 zijn");
...
dom.window.close();
console.log("Path v2.0.184 volledige smoke test: geslaagd");

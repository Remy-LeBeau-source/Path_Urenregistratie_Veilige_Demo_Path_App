...
assert(styles.includes("v0.9.38 · mobiele bediening") && styles.includes("@media (max-width: 720px)"), "Versie 0.9.38 moet een expliciete mobiele touch-layout hebben");
...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.38"), "Het zichtbare versienummer moet 0.9.38 zijn");
...
assert(demoScenarioState.schemaVersion === 23, "Versie 0.9.38 moet wijzigingen onder de juiste gegevensversie bewaren");
...
assert(migratedState.schemaVersion === 23, "Bestaande browsergegevens moeten ook in v0.9.38 veilig behouden blijven");
...
assert(configExSrc.includes("'enabled' => false") && configExSrc.includes("'transport' => 'dry_run'"), "config.example.php moet mail standaard uitgeschakeld hebben met transport dry_run");

console.log("Path v0.9.38 volledige smoke test: geslaagd");

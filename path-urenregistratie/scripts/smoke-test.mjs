...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.199"), "Het zichtbare versienummer moet 2.0.199 zijn");
...
console.log("Path v2.0.199 volledige smoke test: geslaagd");

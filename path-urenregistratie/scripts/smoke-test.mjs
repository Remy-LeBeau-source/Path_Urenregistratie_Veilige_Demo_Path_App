...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.153"), "Het zichtbare versienummer moet 2.0.153 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.153) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.153 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.65"), "Het zichtbare versienummer moet 1.0.65 zijn");
...
dom.window.close();
console.log("Path v1.0.65 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.196"), "Het zichtbare versienummer moet 2.0.196 zijn");
...
console.log("Path v2.0.196 volledige smoke test: geslaagd");

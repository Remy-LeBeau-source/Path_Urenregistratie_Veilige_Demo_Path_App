...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.207"), "Het zichtbare versienummer moet 2.0.207 zijn");
...
console.log("Path v2.0.207 volledige smoke test: geslaagd");

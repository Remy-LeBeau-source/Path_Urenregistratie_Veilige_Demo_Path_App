...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.72"), "Het zichtbare versienummer moet 1.0.72 zijn");
...
dom.window.close();
console.log("Path v1.0.72 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.187"), "Het zichtbare versienummer moet 2.0.187 zijn");
...
console.log("Path v2.0.187 volledige smoke test: geslaagd");

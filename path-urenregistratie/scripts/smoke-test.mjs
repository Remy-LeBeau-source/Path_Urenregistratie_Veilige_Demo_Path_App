...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.59"), "Het zichtbare versienummer moet 2.0.59 zijn");
...
assert(document.querySelector("#employee-customer-timesheet-status").textContent === "Al rechtstreeks gemaild" && document.querySelector("#employee-customer-timesheet-skip").textContent === "Toch een bestand toevoegen", "De medewerker moet de eigen rechtstreekse verzending kunnen zien en terugdraaien");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.59) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.59 volledige smoke test: geslaagd");

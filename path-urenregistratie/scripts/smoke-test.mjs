...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.170"), "Het zichtbare versienummer moet 0.9.170 zijn");
...
dom.window.close();
console.log("Path v0.9.170 volledige smoke test: geslaagd");

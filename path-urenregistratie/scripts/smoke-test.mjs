...
assert(document.querySelector(".demo-badge").textContent.includes("1.2.3"), "Het zichtbare versienummer moet 1.2.3 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v1.2.3) bestaat dezelfde
...
dom.window.close();
console.log("Path v1.2.3 volledige smoke test: geslaagd");

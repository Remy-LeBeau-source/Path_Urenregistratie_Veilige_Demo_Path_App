...
assert(document.querySelector(".demo-badge").textContent.includes("1.2.1"), "Het zichtbare versienummer moet 1.2.1 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v1.2.1) bestaat dezelfde
...
dom.window.close();
console.log("Path v1.2.1 volledige smoke test: geslaagd");

...
assert(styles.includes("v0.9.31 · mobiele bediening") && styles.includes("@media (max-width: 720px)"), "Versie 0.9.31 moet een expliciete mobiele touch-layout hebben");
...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.31"), "Het zichtbare versienummer moet 0.9.31 zijn");
...
assert(demoScenarioState.schemaVersion === 23, "Versie 0.9.31 moet wijzigingen onder de juiste gegevensversie bewaren");
...
assert(migratedState.schemaVersion === 23, "Bestaande browsergegevens moeten ook in v0.9.31 veilig behouden blijven");
...
console.log("Path v0.9.31 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.205"), "Het zichtbare versienummer moet 2.0.205 zijn");
...
console.log("Path v2.0.205 volledige smoke test: geslaagd");

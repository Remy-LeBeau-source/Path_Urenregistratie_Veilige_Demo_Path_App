...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.81"), "Het zichtbare versienummer moet 0.9.81 zijn");
...
dom.window.close();
console.log("Path v0.9.81 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.56"), "Het zichtbare versienummer moet 1.0.56 zijn");
...
dom.window.close();
console.log("Path v1.0.56 volledige smoke test: geslaagd");

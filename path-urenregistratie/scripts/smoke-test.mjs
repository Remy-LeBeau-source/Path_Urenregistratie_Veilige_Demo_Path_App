...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.183"), "Het zichtbare versienummer moet 2.0.183 zijn");
...
dom.window.close();
console.log("Path v2.0.183 volledige smoke test: geslaagd");

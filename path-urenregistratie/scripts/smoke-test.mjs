...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.160"), "Het zichtbare versienummer moet 2.0.160 zijn");
...
dom.window.close();
console.log("Path v2.0.160 volledige smoke test: geslaagd");

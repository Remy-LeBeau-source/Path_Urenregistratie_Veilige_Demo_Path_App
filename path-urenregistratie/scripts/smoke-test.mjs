...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.86"), "Het zichtbare versienummer moet 2.0.86 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.86) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.86 volledige smoke test: geslaagd");

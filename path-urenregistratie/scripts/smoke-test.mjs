...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.172"), "Het zichtbare versienummer moet 2.0.172 zijn");
...
dom.window.close();
console.log("Path v2.0.172 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.192"), "Het zichtbare versienummer moet 2.0.192 zijn");
...
console.log("Path v2.0.192 volledige smoke test: geslaagd");

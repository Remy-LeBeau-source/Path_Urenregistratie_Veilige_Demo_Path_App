...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.62"), "Het zichtbare versienummer moet 1.0.62 zijn");
...
dom.window.close();
console.log("Path v1.0.62 volledige smoke test: geslaagd");

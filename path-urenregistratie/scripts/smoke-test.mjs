...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.50"), "Het zichtbare versienummer moet 1.0.50 zijn");
...
dom.window.close();
console.log("Path v1.0.50 volledige smoke test: geslaagd");

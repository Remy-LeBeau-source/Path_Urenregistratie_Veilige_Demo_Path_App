...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.82"), "Het zichtbare versienummer moet 0.9.82 zijn");
...
dom.window.close();
console.log("Path v0.9.82 volledige smoke test: geslaagd");

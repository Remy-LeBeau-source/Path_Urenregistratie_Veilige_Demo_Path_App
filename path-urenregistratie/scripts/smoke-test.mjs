...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.170"), "Het zichtbare versienummer moet 2.0.170 zijn");
...
dom.window.close();
console.log("Path v2.0.170 volledige smoke test: geslaagd");

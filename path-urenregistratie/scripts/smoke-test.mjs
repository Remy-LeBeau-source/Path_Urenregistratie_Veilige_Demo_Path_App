...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.189"), "Het zichtbare versienummer moet 2.0.189 zijn");
...
console.log("Path v2.0.189 volledige smoke test: geslaagd");

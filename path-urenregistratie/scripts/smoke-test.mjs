...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.42"), "Het zichtbare versienummer moet 2.0.42 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.42) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.42 volledige smoke test: geslaagd");

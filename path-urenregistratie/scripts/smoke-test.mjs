...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.158"), "Het zichtbare versienummer moet 0.9.158 zijn");
...
dom.window.close();
console.log("Path v0.9.158 volledige smoke test: geslaagd");

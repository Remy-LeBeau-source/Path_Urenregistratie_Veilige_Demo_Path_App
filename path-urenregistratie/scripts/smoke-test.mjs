...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.99"), "Het zichtbare versienummer moet 1.0.99 zijn");
...
dom.window.close();
console.log("Path v1.0.99 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.91"), "Het zichtbare versienummer moet 0.9.91 zijn");
...
dom.window.close();
console.log("Path v0.9.91 volledige smoke test: geslaagd");

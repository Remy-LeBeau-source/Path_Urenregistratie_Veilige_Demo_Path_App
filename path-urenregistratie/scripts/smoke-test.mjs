...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.182"), "Het zichtbare versienummer moet 2.0.182 zijn");
...
dom.window.close();
console.log("Path v2.0.182 volledige smoke test: geslaagd");

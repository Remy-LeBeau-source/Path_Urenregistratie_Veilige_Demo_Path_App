...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.14"), "Het zichtbare versienummer moet 1.0.14 zijn");
...
dom.window.close();
console.log("Path v1.0.14 volledige smoke test: geslaagd");

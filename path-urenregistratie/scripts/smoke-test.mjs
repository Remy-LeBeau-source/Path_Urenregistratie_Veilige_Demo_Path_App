...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.78"), "Het zichtbare versienummer moet 1.0.78 zijn");
...
dom.window.close();
console.log("Path v1.0.78 volledige smoke test: geslaagd");

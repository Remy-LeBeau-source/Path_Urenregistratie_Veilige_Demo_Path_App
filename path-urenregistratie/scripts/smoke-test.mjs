...
assert(document.querySelector(".demo-badge").textContent.includes("1.2.0"), "Het zichtbare versienummer moet 1.2.0 zijn");
...
dom.window.close();
console.log("Path v1.2.0 volledige smoke test: geslaagd");

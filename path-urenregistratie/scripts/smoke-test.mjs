...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.82"), "Het zichtbare versienummer moet 1.0.82 zijn");
...
dom.window.close();
console.log("Path v1.0.82 volledige smoke test: geslaagd");

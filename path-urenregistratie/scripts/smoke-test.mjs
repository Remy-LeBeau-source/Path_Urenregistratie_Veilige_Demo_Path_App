...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.92"), "Het zichtbare versienummer moet 2.0.92 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.92) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.92 volledige smoke test: geslaagd");

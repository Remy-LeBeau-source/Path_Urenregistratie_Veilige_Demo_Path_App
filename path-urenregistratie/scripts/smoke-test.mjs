...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.57"), "Het zichtbare versienummer moet 1.0.57 zijn");
...
dom.window.close();
console.log("Path v1.0.57 volledige smoke test: geslaagd");

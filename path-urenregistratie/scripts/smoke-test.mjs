...
assert(styles.includes("v0.9.44 · mobiele bediening") && styles.includes("@media (max-width: 720px)"), "Versie 0.9.44 moet een expliciete mobiele touch-layout hebben");
...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.44"), "Het zichtbare versienummer moet 0.9.44 zijn");
...
assert(demoScenarioState.schemaVersion === 25, "Versie 0.9.44 moet wijzigingen onder de juiste gegevensversie bewaren");
...
assert(migratedState.schemaVersion === 25, "Bestaande browsergegevens moeten ook in v0.9.44 veilig behouden blijven");
...
console.log("Path v0.9.44 volledige smoke test: geslaagd");

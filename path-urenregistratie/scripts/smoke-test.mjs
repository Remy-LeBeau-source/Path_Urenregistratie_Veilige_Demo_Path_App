...
assert(document.querySelector(".demo-badge").textContent.includes("1.1.3"), "Het zichtbare versienummer moet 1.1.3 zijn");
...
dom.window.close();
console.log("Path v1.1.3 volledige smoke test: geslaagd");

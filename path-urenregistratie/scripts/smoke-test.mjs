...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.6"), "Het zichtbare versienummer moet 2.0.6 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.6) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.6 volledige smoke test: geslaagd");

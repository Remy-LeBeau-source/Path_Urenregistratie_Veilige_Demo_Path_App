...
assert(document.querySelector(".demo-badge").textContent.includes("1.1.4"), "Het zichtbare versienummer moet 1.1.4 zijn");
...
dom.window.close();
console.log("Path v1.1.4 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.8"), "Het zichtbare versienummer moet 1.0.8 zijn");
...
dom.window.close();
console.log("Path v1.0.8 volledige smoke test: geslaagd");

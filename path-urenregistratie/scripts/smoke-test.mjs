...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.43"), "Het zichtbare versienummer moet 1.0.43 zijn");
...
dom.window.close();
console.log("Path v1.0.43 volledige smoke test: geslaagd");

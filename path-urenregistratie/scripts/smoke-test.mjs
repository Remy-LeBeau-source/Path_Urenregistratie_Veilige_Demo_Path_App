...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.98"), "Het zichtbare versienummer moet 1.0.98 zijn");
...
dom.window.close();
console.log("Path v1.0.98 volledige smoke test: geslaagd");

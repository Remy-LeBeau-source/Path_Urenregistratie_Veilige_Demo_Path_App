...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.209"), "Het zichtbare versienummer moet 2.0.209 zijn");
...
console.log("Path v2.0.209 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.85"), "Het zichtbare versienummer moet 0.9.85 zijn");
...
dom.window.close();
console.log("Path v0.9.85 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.112"), "Het zichtbare versienummer moet 0.9.112 zijn");
...
dom.window.close();
console.log("Path v0.9.112 volledige smoke test: geslaagd");

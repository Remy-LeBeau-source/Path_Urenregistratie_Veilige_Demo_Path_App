...
assert(document.querySelector(".demo-badge").textContent.includes("1.2.4"), "Het zichtbare versienummer moet 1.2.4 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v1.2.4) bestaat dezelfde
...
dom.window.close();
console.log("Path v1.2.4 volledige smoke test: geslaagd");

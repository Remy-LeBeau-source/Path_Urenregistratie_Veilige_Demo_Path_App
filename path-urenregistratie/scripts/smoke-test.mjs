...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.176"), "Het zichtbare versienummer moet 2.0.176 zijn");
...
dom.window.close();
console.log("Path v2.0.176 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.203"), "Het zichtbare versienummer moet 2.0.203 zijn");
...
console.log("Path v2.0.203 volledige smoke test: geslaagd");

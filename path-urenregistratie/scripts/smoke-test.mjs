...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.61"), "Het zichtbare versienummer moet 2.0.61 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.61) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.61 volledige smoke test: geslaagd");

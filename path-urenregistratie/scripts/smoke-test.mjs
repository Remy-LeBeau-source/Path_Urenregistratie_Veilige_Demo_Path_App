...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.54"), "Het zichtbare versienummer moet 1.0.54 zijn");
...
dom.window.close();
console.log("Path v1.0.54 volledige smoke test: geslaagd");

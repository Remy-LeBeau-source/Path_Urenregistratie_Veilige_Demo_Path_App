...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.16"), "Het zichtbare versienummer moet 2.0.16 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.16) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.16 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.198"), "Het zichtbare versienummer moet 2.0.198 zijn");
...
console.log("Path v2.0.198 volledige smoke test: geslaagd");

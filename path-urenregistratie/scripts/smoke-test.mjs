...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.53"), "Het zichtbare versienummer moet 2.0.53 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.53) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.53 volledige smoke test: geslaagd");

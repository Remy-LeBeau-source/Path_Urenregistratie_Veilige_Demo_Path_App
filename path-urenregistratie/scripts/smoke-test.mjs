...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.173"), "Het zichtbare versienummer moet 0.9.173 zijn");
...
dom.window.close();
console.log("Path v0.9.173 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("1.2.2"), "Het zichtbare versienummer moet 1.2.2 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v1.2.2) bestaat dezelfde
...
dom.window.close();
console.log("Path v1.2.2 volledige smoke test: geslaagd");

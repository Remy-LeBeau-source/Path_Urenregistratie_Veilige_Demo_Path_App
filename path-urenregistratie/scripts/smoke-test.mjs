...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.201"), "Het zichtbare versienummer moet 2.0.201 zijn");
...
console.log("Path v2.0.201 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("0.9.160"), "Het zichtbare versienummer moet 0.9.160 zijn");
...
dom.window.close();
console.log("Path v0.9.160 volledige smoke test: geslaagd");

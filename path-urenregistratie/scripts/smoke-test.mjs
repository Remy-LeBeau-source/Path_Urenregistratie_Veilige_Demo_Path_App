...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.166"), "Het zichtbare versienummer moet 2.0.166 zijn");
...
dom.window.close();
console.log("Path v2.0.166 volledige smoke test: geslaagd");

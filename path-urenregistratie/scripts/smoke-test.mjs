...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.149"), "Het zichtbare versienummer moet 2.0.149 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.149) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.149 volledige smoke test: geslaagd");

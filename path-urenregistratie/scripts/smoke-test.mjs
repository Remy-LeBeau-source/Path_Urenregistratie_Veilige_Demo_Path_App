...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.156"), "Het zichtbare versienummer moet 2.0.156 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.156) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.156 volledige smoke test: geslaagd");

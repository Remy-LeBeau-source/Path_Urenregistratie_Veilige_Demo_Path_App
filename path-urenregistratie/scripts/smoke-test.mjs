...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.33"), "Het zichtbare versienummer moet 1.0.33 zijn");
...
dom.window.close();
console.log("Path v1.0.33 volledige smoke test: geslaagd");

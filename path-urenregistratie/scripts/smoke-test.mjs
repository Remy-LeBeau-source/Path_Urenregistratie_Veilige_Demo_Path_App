...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.142"), "Het zichtbare versienummer moet 2.0.142 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.142) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.142 volledige smoke test: geslaagd");

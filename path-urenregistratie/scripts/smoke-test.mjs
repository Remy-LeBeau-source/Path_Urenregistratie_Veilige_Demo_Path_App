...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.76"), "Het zichtbare versienummer moet 2.0.76 zijn");
...
// Sinds Klanturenstaten een eigen scherm heeft (v2.0.76) bestaat dezelfde
...
dom.window.close();
console.log("Path v2.0.76 volledige smoke test: geslaagd");

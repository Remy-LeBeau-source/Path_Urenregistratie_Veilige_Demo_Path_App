...
assert(document.querySelector(".demo-badge").textContent.includes("1.0.31"), "Het zichtbare versienummer moet 1.0.31 zijn");
...
dom.window.close();
console.log("Path v1.0.31 volledige smoke test: geslaagd");

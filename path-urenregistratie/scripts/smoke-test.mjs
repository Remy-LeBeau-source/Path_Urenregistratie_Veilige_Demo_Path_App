...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.194"), "Het zichtbare versienummer moet 2.0.194 zijn");
...
dom.window.close();
console.log("Path v2.0.194 volledige smoke test: geslaagd");

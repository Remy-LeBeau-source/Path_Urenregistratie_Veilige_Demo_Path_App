...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.195"), "Het zichtbare versienummer moet 2.0.195 zijn");
...
console.log("Path v2.0.195 volledige smoke test: geslaagd");

...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.197"), "Het zichtbare versienummer moet 2.0.197 zijn");
...
console.log("Path v2.0.197 volledige smoke test: geslaagd");

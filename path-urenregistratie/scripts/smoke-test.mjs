...
assert(document.querySelector(".demo-badge").textContent.includes("2.0.206"), "Het zichtbare versienummer moet 2.0.206 zijn");
...
console.log("Path v2.0.206 volledige smoke test: geslaagd");

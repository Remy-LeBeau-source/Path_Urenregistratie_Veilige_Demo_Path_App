...
# [TS-REV-API-H-005] Admin vraagt correctie aan met expected_version.
# [TS-REV-API-H-006] Medewerker dient na correctie opnieuw in.
# [TS-REV-API-H-007] Admin keurt herindiening goed.
# [TS-REV-UI-H-008] Correctieverzoek via UI wordt zichtbaar voor medewerker.
# [TS-REV-UI-H-009] Herindiening + goedkeuring via UI eindigt in Goedgekeurd.
...
# [TS-REV-API-N-012] Verouderde expected_version geeft conflict.
  ...
  Scenario: [TS-REV-API-H-005] Administrator vraagt correctie aan met optimistic locking
  ...
  Scenario: [TS-REV-API-H-006] Medewerker dient na correctieverzoek opnieuw in
  ...
  Scenario: [TS-REV-API-H-007] Administrator keurt heringediende uren goed met version check
  ...
  Scenario: [TS-REV-UI-H-008] Administrator vraagt via de browser-UI een correctie aan
  ...
  Scenario: [TS-REV-UI-H-009] Medewerker dient na UI-correctie opnieuw in en administrator keurt goed
  ...
  Scenario: [TS-API-N-011] Ingediende urenstaat kan niet opnieuw als concept worden opgeslagen
  ...
  Scenario: [TS-REV-API-N-012] Verouderde expected_version wordt geblokkeerd
    Given een ingediende urenstaat met bekende versie

...
# Step definitions mapping: tests/playwright/steps/timesheets.steps.ts
  ...
  Scenario: Medewerker slaat concepturen op met versiebeheer
  ...
  Scenario: Medewerker leest volledige conceptinhoud terug
  ...
  Scenario: Medewerker dient eigen uren in met versieverhoging
  ...
  Scenario: Medewerker kan geen uren van een andere medewerker aanpassen
  ...
  Scenario: Indienen schrijft audit-event voor traceerbaarheid
  ...
  Scenario: Ingediende urenstaat kan niet opnieuw als concept worden opgeslagen
  ...
  Scenario: Administrator vraagt correctie aan met optimistic locking
  ...
  Scenario: Medewerker dient na correctieverzoek opnieuw in
  ...
  Scenario: Administrator keurt heringediende uren goed met version check
  ...
  Scenario: Verouderde expected_version wordt geblokkeerd
    Given een ingediende urenstaat met bekende versie

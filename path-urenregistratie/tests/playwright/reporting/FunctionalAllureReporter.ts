...
const FILE_CLASSIFICATIONS: Record<string, TestClassification> = {
  ...
  'database-integrity.spec.ts': { parentSuite: 'DB / Integratie', suite: 'Database Integrity', feature: 'Database-integriteit', domain: 'database', phase: 16, type: 'integration' },
  'email-queue.spec.ts': { parentSuite: 'API', suite: 'Email Queue', feature: 'E-mailverwerking', domain: 'email', phase: 12, type: 'api' },
  'help-widget.spec.ts': { parentSuite: 'UI Desktop', suite: 'Help Widget', feature: 'Hulp & Contact', domain: 'help', phase: 17, type: 'ui' },
  ...
  'pilot-page.spec.ts': { parentSuite: 'UI Desktop', suite: '1919 Pilot', feature: '1919 Pilot', domain: 'pilot', phase: 18, type: 'ui' },
...
const LIVING_DOCS_BY_SPEC: Record<string, string> = {
  ...
  'database-integrity.spec.ts': 'tests/playwright/features/database-relations.feature',
  'email-queue.spec.ts': 'tests/playwright/features/mail-delivery.feature',
  'help-widget.spec.ts': 'tests/playwright/features/help-widget.feature',
  'invoice-lock.spec.ts': 'tests/playwright/features/invoice-locking.feature',
  'invoices.spec.ts': 'tests/playwright/features/invoices.feature',
  ...
  'pilot-page.spec.ts': 'tests/playwright/features/pilot-page.feature',
  ...
  'roles-api.spec.ts': 'tests/playwright/features/roles-authorization.feature',
  'security.spec.ts': 'tests/playwright/features/security.feature',
  'timesheet-review-flow.spec.ts': 'tests/playwright/features/correction-approval-workflow.feature',
  'timesheet-review-ui.spec.ts': 'tests/playwright/features/correction-approval-ui.feature',
  'timesheet-write.spec.ts': 'tests/playwright/features/time-registration.feature',
  'user-management.spec.ts': 'tests/playwright/features/team-access.feature',
};

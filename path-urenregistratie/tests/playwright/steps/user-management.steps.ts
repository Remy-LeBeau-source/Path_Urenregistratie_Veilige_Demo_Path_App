...
export const caseMappings = [
  ...
  { caseId: 'USR-H-003', spec: 'user-management.spec.ts', assertionCount: 2, acceptanceCriteria: ["Then wordt met Playwright-assertions bevestigd dat admin kan force_password_change instellen"] },

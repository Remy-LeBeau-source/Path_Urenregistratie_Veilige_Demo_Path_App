...
export const caseMappings = [
  ...
  { caseId: 'SAFE-H-005', spec: 'production-safety.spec.ts', assertionCount: 11, acceptanceCriteria: ["Then zijn TLS, dry-run, private storage, HSTS en niet-mutatieve checks afgedwongen"] },
] as const;

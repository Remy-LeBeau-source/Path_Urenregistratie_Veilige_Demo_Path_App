...
// invoices_month_name() en invoices_build_pdf_bytes() stonden hier; ze staan
// nu in de lib omdat de TEST-reset dezelfde factuur moet kunnen bouwen en dit
// bestand een endpoint is dat bij inladen meteen het verzoek afhandelt.
...
{
    $pdfBytes = invoices_build_pdf_bytes($pdo, $invoiceId, $companyId);
    if ($pdfBytes === null) {
        return false;
    }

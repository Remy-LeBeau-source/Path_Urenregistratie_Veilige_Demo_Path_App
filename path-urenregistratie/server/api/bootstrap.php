...
try {
    $companiesStmt = $pdo->prepare(
        'SELECT id, slug, legal_name, trade_name, invoice_name_display, app_name, support_name, support_email, website, tagline, brand_primary, brand_accent, chamber_of_commerce_number, vat_number, iban, address_line, postal_code, city, invoice_phone, invoice_email, country_code, invoice_prefix, payment_term_days, customer_timesheet_reminder_enabled, customer_timesheet_reminder_time, customer_timesheet_overdue_workdays, weekly_reminder_enabled, weekly_reminder_day, weekly_reminder_time, month_end_reminder_enabled, month_end_reminder_time, overdue_reminder_enabled, overdue_reminder_time, approval_reminder_enabled, approval_reminder_time, mail_signature, customer_timesheet_submission_subject, customer_timesheet_submission_body, customer_timesheet_broker_subject, customer_timesheet_broker_body, leave_sick_entry_enabled, created_at, updated_at FROM companies WHERE id = :company_id ORDER BY id'
    );

...
Versie v0.9.100 van een configureerbare uren- en facturatieapp. Path Consultancy is de handelsnaam; QSI Consultancy B.V. is de juridische onderneming in de volledig ingevulde voorbeeldorganisatie.
...
- De officiële **klanturenstaat** is een apart, verplicht proces met eigen periodekeuze, concept, indiening, controle, herinneringen en optionele brokerroute. Een ingediend document (`received`) of **Al rechtstreeks gemaild** met reden is voldoende voor factuurafronding; externe bevestiging blijft een aparte optionele Backoffice-actie. De eerste e-mail loopt van medewerker naar Backoffice; na controle volgt een aparte e-mail van Backoffice naar de broker. Beide organisatiestandaarden zijn bewerkbaar en de medewerker kan zijn eigen bericht vóór indienen per maand aanpassen. PDF blijft ongewijzigd; JPG en PNG worden fail-closed als één gestandaardiseerde PDF opgeslagen. De PDF opent inline met een `.pdf`-bestandsnaam en blijft na herladen, opnieuw inloggen en maandwisselen zichtbaar voor de medewerker. De app maakt zelf geen klanturenstaat.
- **Mijn overzicht** toont de klanturenstaat als een aparte maandtaak. Ook bij goedgekeurde uren toont de maandstatus `Wacht op klanturenstaat` zolang het document ontbreekt, als concept klaarstaat of opnieuw moet worden geüpload; factuurafronding blijft dan geblokkeerd.
- Met **Die heb ik al gemaild** kan een medewerker de klanturenstaat afronden wanneer deze buiten de app naar Path Backoffice is gestuurd. Een verplichte reden, medewerker en tijdstip worden bewaard. Backoffice ziet deze gegevens in de maanddetails; de taak verdwijnt uit de open werkvoorraad maar blijft in de historie zichtbaar. **Toch een bestand toevoegen** draait de registratie terug.

...
CREATE TABLE companies (
  ...
  mail_signature VARCHAR(120) NOT NULL DEFAULT 'Robot Path IT',
...
CREATE TABLE email_deliveries (
  ...
  attachment_policy ENUM('none', 'invoice', 'customer_timesheet', 'invoice_and_customer_timesheet', 'timesheet_receipt') NOT NULL DEFAULT 'none',
  pdf_storage_key VARCHAR(255) NULL,
